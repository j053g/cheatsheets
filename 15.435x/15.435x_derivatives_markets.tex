...
\begin{description}[topsep=0pt]
	\item[The Merton Model] ~
	\begin{itemize}[topsep=0pt]
		\item Today is $t=0$ and consider a firm with current assets $V_0=E_0+D_0$
		\item The payoff to equity holders is then the one of a call option
		\item  If we denote $E_0$ the value of equity today
