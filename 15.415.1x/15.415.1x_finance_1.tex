...
\begin{description}[itemsep=0pt]
	...
	\item NI: net income, 
	 $\Delta D$ : funds raised from new debt issue,
	 $\Delta E$ : funds raised from new equity issue,
	 $I$: investment,
	 $C$: coupon payment,
...
\begin{description}[itemsep=0pt]
	\item[Bond prices and interest rates]  ~
	\begin{itemize}
		\item Prices of discount bonds provide information about spot interest rates: $DF_t=\frac{1}{(1+s_t)^t} \implies s_t = (\frac{1}{DF_t})^{(\frac{1}{t})}-1$ 
		\item Price of one price: $B= FV \cdot B_T + \sum_{t=1}^{T} C_t B_t $
	\end{itemize}
\end{description}
...
\begin{description}[itemsep=0pt]
	\item[Growth Opportunities and Stock Valuation]  ~
	\begin{itemize}
...
\begin{description}[itemsep=0pt]
	...
	\begin{itemize}
		...
		\item $NPV = CF_0 + \frac{CF_1}{1+r_1}+\frac{CF_2}{(1+r_2)^2} + \cdots + \frac{CF_T}{(1+r_T)^T} $
		...
		\item {\bf Cash Flow:} 
			...
			\end{align*}
		\item {\bf Working Capital:} $WC = Inventory + A/R - A/P$, $A/R : \text{Accounts Receivable}$, $A/P : \text{Accounts Payable}$
