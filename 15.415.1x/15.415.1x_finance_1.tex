...
\begin{description}[itemsep=0pt]
	...
	\begin{itemize}
		...
		\item {\bf Next year earnings $EPS_{t+1}$:} $$ EPS_{t+1} = EPS_t +ROI_t \cdot I_t $$
		\item {\bf Next year book value $BVPS_{t+1}$:} $$ BVPS_{t+1} = BVPS_t + I_{t+1} $$\\
		\item {\bf Dividedns $D_t$:} $$ D_t = EPS_t (1-b_t) $$
