...
Given recovery rate of $RR$ and probability of default $PD$, expected yield $\bar{y}$ and promised yield $y$, then: $1 + \bar{y} = (1-PD)(1+y)+PD[(1-RR)(1+y)]$, solve for $y$ to know coupon to issue at par.