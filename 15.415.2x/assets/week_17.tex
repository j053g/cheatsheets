...
\begin{tikzpicture}[scale=0.5]
	...
	\draw [-latex, ,xshift=5pt, right](6,3.5)--(5.5,3.5) node [right, ,xshift=5pt] {\footnotesize Promised YTM};
	\draw [-latex, ,xshift=5pt, right](6,4.5)--(5.5,4.5) node [right, ,xshift=5pt] {\footnotesize Expected YTM};
	\draw [-latex, ,xshift=5pt, right](6,5.5)--(5.5,5.5) node [right, ,xshift=5pt] {\footnotesize Default-free YTM};
\end{tikzpicture}
